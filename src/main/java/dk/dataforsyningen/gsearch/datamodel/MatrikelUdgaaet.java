...
public class MatrikelUdgaaet {

  @Schema(description = "Ejerlavsnavn for udgået matrikel")
  private String ejerlavsnavn;

  @Schema(description = "Ejerlavskode for udgået matrikel")
  private Integer ejerlavskode;

  @Schema(description = "Kommunenavn for udgået matrikel")
  private String kommunenavn;

  @Schema(description = "Kommunekode(r) for kommune(r) der ligger i eller optil udgået matrikel")
  private String kommunekode;

  @Schema(description = "Matrikelnummer udgået")
  private String matrikelnummer;

  @Schema(description = "Præsentationsform for et udgået matrikel")
  private String visningstekst;

  @Schema(description = "Jordstykke lokalid")
  private Integer jordstykke_id;

  @Schema(description = "BFE-nummer for udgået matrikel")
  private Integer bfenummer;

  @Schema(description = "Centroide X for udgået matriklens geometri i den valgte EPSG kode, default EPSG:25832")
  private BigDecimal centroid_x;

  @Schema(description = "Centroide Y for udgået matriklens geometri i den valgte EPSG kode, default EPSG:25832")
  ...
  public MatrikelUdgaaet() {
  }

  public MatrikelUdgaaet(String ejerlavsnavn, Integer ejerlavskode, String kommunenavn,
                         String kommunekode, String matrikelnummer, String visningstekst,
                         Integer jordstykke_id, Integer bfenummer, BigDecimal centroid_x,
                         BigDecimal centroid_y, Geometry geometri) {
