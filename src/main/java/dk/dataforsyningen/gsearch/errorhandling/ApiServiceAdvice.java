...
public class ApiServiceAdvice extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleEmptyResultDataAccessException(
    ...
    ErrorResponse errorResponse =
        new ErrorResponse(HttpStatus.NOT_FOUND, exception.getLocalizedMessage(), exceptionCause);
    logger.debug(ERROR_STRING, exception);
    logger.debug(ERROR_STRING + errorResponse.getErrors());
  ...
  public ResponseEntity<ErrorResponse> handleUnableToExecuteStatementException(
    ...
    String exceptionCause = getRootCause(exception).toString();
    ErrorResponse errorResponse =
        new ErrorResponse(HttpStatus.BAD_REQUEST, "UnableToExecuteStatementException",
            "Invalid input");
    logger.info(ERROR_STRING, exception);
    logger.info(ERROR_STRING + exceptionCause);
    return new ResponseEntity<>(errorResponse, HttpStatus.BAD_REQUEST);
  ...
  public ResponseEntity<ErrorResponse> handleUnknownHostException(
    ...
    String exceptionCause = getRootCause(exception).toString();
    ErrorResponse errorResponse =
        new ErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR, "UnknownHostException",
            "Host not found");
    logger.info(ERROR_STRING, exception);
    logger.info(ERROR_STRING + exceptionCause);
  ...
  public ResponseEntity<Object> handleSQLNonTransientConnectionException(
    ...
    ErrorResponse errorResponse =
        new ErrorResponse(HttpStatus.CONFLICT, exception.getLocalizedMessage(),
            exceptionCause);
    logger.info(ERROR_STRING, exception);
    logger.info(ERROR_STRING + exceptionCause);
