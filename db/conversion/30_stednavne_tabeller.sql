...
(
    ...
    visningstekst        character varying,
    area                 float,
...
CREATE INDEX stednavn_udstilling_type_presentation_idx ON stednavne_udstil.stednavn_udstilling (type, visningstekst);
...
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = s1.skrivemaade || ' (Bydel i ' || s2.skrivemaade || ')'
...
WHERE stednavne_udstil.stednavn_udstilling.visningstekst IS NULL
...
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = s.skrivemaade || ' (by i ' || p.navn || ')'
FROM stednavne_udstil.stednavn_udstilling s
         JOIN
...
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = s.skrivemaade || ' (' || s.subtype_presentation || ' i ' || p.navn || ')'
FROM stednavne_udstil.stednavn_udstilling s
         JOIN
     dagi_500.postnummerinddeling p ON (ST_contains(p.geometri, s.geometri_udtyndet))
WHERE stednavne_udstil.stednavn_udstilling.visningstekst IS NULL
...
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = s.skrivemaade || ' (Begravelsesplads i ' || p.navn || ')'
FROM stednavne_udstil.stednavn_udstilling s
         JOIN
     dagi_500.postnummerinddeling p ON (ST_contains(p.geometri, s.geometri_udtyndet))
WHERE stednavne_udstil.stednavn_udstilling.visningstekst IS NULL
...
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = replace(visningstekst, '(Begravelsesplads i ', '(')
WHERE type ilike 'begravelsesplads'
...
SET visningstekst = s.skrivemaade || ' (' ||
...
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = replace(visningstekst, 'Akvariet (Akvarium i ', 'Akvariet (')
WHERE type ilike 'bygning'
  AND subtype ilike 'Akvarium';
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = replace(visningstekst, 'Akvarium (Akvarium i ', 'Akvariet (')
WHERE type ilike 'bygning'
  AND subtype ilike 'Akvarium';
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = replace(visningstekst, 'akvariet (Akvarium i ', 'Akvariet (')
...
-- Helt indenfor et postnummerinddeling
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = s.skrivemaade || ' (Campingplads i ' || p.navn || ')'
FROM stednavne_udstil.stednavn_udstilling s
         JOIN
     dagi_500.postnummerinddeling p ON (ST_contains(p.geometri, s.geometri_udtyndet))
WHERE stednavne_udstil.stednavn_udstilling.visningstekst IS NULL
...
-- Justeringer af visningstekst (når typen oplagt fremgår af skrivemaade)
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = replace(visningstekst, '(Campingplads i ', '(')
WHERE type ilike 'campingplads'
...
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = s.skrivemaade || ' (' || s.subtype_presentation || ' i ' || s2.skrivemaade || ')'
FROM stednavne_udstil.stednavn_udstilling s
         JOIN
     stednavne_udstil.stednavn_udstilling s2 ON (s2.visningstekst IS NOT NULL AND s2.type ilike 'farvand' AND
...
WHERE st_geometrytype(stednavne_udstil.stednavn_udstilling.geometri_udtyndet) = 'ST_MultiPoint'
  AND stednavne_udstil.stednavn_udstilling.visningstekst IS NULL
  AND stednavne_udstil.stednavn_udstilling.type ilike 'fortidsminde'
  AND stednavne_udstil.stednavn_udstilling.objectid = s.objectid
  AND stednavne_udstil.stednavn_udstilling.navnefoelgenummer = s.navnefoelgenummer;
...
-- Fortidsminder i postnummerinddeling
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = s.skrivemaade || ' (' || 'Friluftsbad' || ' i ' || p.navn || ')'
FROM stednavne_udstil.stednavn_udstilling s
         JOIN
     dagi_500.postnummerinddeling p ON (ST_contains(p.geometri, s.geometri_udtyndet))
WHERE stednavne_udstil.stednavn_udstilling.visningstekst IS NULL
...
-- Justeringer af visningstekst (når subtypen oplagt fremgår af skrivemaade)
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = replace(visningstekst, '(Friluftsbad i ', '(')
WHERE type ilike 'friluftsbad'
...
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = s1.skrivemaade || ' (' || s1.subtype_presentation || ' i ' || s2.skrivemaade || ')'
FROM stednavne_udstil.stednavn_udstilling s1
         JOIN
     stednavne_udstil.stednavn_udstilling s2
...
-- Justeringer af visningstekst (når subtypen oplagt fremgår af skrivemaade)
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = replace(visningstekst, '(Bakke i ', '(')
WHERE type ilike 'landskabsform'
  AND skrivemaade ilike '%Bakke%';
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = replace(visningstekst, '(Dal i ', '(')
WHERE type ilike 'landskabsform'
...
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = skrivemaade || ' (' || subtype_presentation || ')'
WHERE stednavne_udstil.stednavn_udstilling.visningstekst IS NULL
...
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = s.skrivemaade || ' (' || p.navn || ')'
FROM stednavne_udstil.stednavn_udstilling s
         JOIN
     dagi_500.postnummerinddeling p ON (ST_contains(p.geometri, s.geometri_udtyndet))
WHERE stednavne_udstil.stednavn_udstilling.visningstekst IS NULL
...
-- andentopografiflade --
-------------------------
-- SELECT * from stednavne_udstil.stednavn_udstilling where type='andentopografiflade' AND visningstekst IS NULL;
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = NULL
...
-- andentopografipunkt --
-------------------------
-- SELECT * from stednavne_udstil.stednavn_udstilling where type='andentopografipunkt' AND visningstekst = NULL;
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = NULL
...
-- Juster broer
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = replace(visningstekst, '(bro i ', '(')
WHERE type ilike 'andentopografipunkt'
  AND skrivemaade ilike '% bro%';
-- Juster kilder
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = replace(visningstekst, '(kilde i ', '(')
WHERE type ilike 'andentopografipunkt'
...
-- faergerutelinje --
---------------------
-- SELECT * from stednavne_udstil.stednavn_udstilling where type='faergerutelinje' AND visningstekst IS NULL;
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = NULL
...
-- idraetsanlaeg --
-------------------
-- SELECT * from stednavne_udstil.stednavn_udstilling where type='idraetsanlaeg' AND visningstekst IS NULL;
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = NULL
...
-- Juster cykelbaner
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = replace(visningstekst, '(cykelbane i ', '(')
WHERE type ilike 'idraetsanlaeg'
  AND skrivemaade ilike '%cykelbane%';
-- Juster golfklubber
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = replace(visningstekst, '(golfbane i ', '(')
WHERE type ilike 'idraetsanlaeg'
  AND skrivemaade ilike '% golf%';
-- Juster travbaner og galopbaner
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = replace(visningstekst, '(hestevæddeløbsbane i ', '(')
WHERE type ilike 'idraetsanlaeg'
  AND (skrivemaade ilike '%galopbane%' OR skrivemaade ilike '%travbane%');
-- Juster motocross baner
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = replace(visningstekst, '(motocrossbane i ', '(')
WHERE type ilike 'idraetsanlaeg'
  AND (skrivemaade ilike '%motocross%');
-- Juster skydebane
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = replace(visningstekst, '(skydebane i ', '(')
WHERE type ilike 'idraetsanlaeg'
  AND (skrivemaade ilike '%skydebane%' OR skrivemaade ilike '%skytteforening%');
-- Juster stadion
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = replace(visningstekst, '(stadion i ', '(')
WHERE type ilike 'idraetsanlaeg'
...
-- soe --
---------
-- SELECT * from stednavne_udstil.stednavn_udstilling where type='soe' AND visningstekst IS NULL;
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = NULL
...
-- Juster Sø
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = replace(visningstekst, '(sø i ', '(')
WHERE type ilike 'soe'
...
-- standsningssted --
---------------------
-- SELECT * from stednavne_udstil.stednavn_udstilling where type='standsningssted' AND visningstekst IS NULL;
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = NULL
WHERE type ilike 'standsningssted';
-- Helt indenfor et postnummerinddeling
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = s.skrivemaade || ' (' || s.type || ', ' || s.subtype_presentation || ' i ' || p.navn || ')'
FROM stednavne_udstil.stednavn_udstilling s
         JOIN
     dagi_500.postnummerinddeling p ON (ST_contains(p.geometri, s.geometri_udtyndet))
WHERE stednavne_udstil.stednavn_udstilling.visningstekst IS NULL
...
-- Øvrige
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = skrivemaade || ' (' || type || ', ' || subtype_presentation || ')'
WHERE stednavne_udstil.stednavn_udstilling.visningstekst IS NULL
  AND stednavne_udstil.stednavn_udstilling.type ilike 'standsningssted';
...
--------------------------
-- SELECT * from stednavne_udstil.stednavn_udstilling where type='ubearbejdetnavnflade' AND visningstekst IS NULL;
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = NULL
...
--------------------------
-- SELECT * from stednavne_udstil.stednavn_udstilling where type='ubearbejdetnavnlinje' AND visningstekst IS NULL;
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = NULL
...
--------------------------
-- SELECT * from stednavne_udstil.stednavn_udstilling where type='ubearbejdetnavnpunkt' AND visningstekst IS NULL;
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = NULL
...
-- vej --
--------------------------
-- SELECT * from stednavne_udstil.stednavn_udstilling where type='vej' AND visningstekst IS NULL;
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = NULL
WHERE type ilike 'ubearbejdetnavnpunkt';
-- Helt indenfor et postnummerinddeling
...
-- På store ø'er
UPDATE stednavne_udstil.stednavn_udstilling
SET visningstekst = s1.skrivemaade || ' (' || s1.subtype_presentation || ' på ' || s2.skrivemaade || ')'
FROM stednavne_udstil.stednavn_udstilling s1
         JOIN
     stednavne_udstil.stednavn_udstilling s2
...
UPDATE
    stednavne_udstil.stednavn_udstilling
SET visningstekst = skrivemaade || ' (' || type || ')'
WHERE stednavne_udstil.stednavn_udstilling.visningstekst IS NULL
