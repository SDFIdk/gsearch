...
-- Dumped by pg_dump version 14.2 (Ubuntu 14.2-1ubuntu1)
    ...
    -- Elvis har udkommenteret dette 26. sep 2022, fordi det bliver nu en del af seedingen.
    ...
    INSERT INTO fonetik.fonetiskregel VALUES (8, 1, 'È', 'E', NULL, 1, 1);
    INSERT INTO fonetik.fonetiskregel VALUES (9, 1, 'É', 'E', NULL, 1, 1);
    ...
    INSERT INTO fonetik.fonetiskregel VALUES (21, 1, 'VÆNGE ', ' VÆNGE ', NULL, 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (22, 1, 'VÆNGET ', ' VÆNGE ', NULL, 1, 0);
    ...
    INSERT INTO fonetik.fonetiskregel VALUES (37, 1, 'STRÆDE ', ' STRÆDE ', NULL, 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (38, 1, 'STRÆDET ', ' STRÆDE ', NULL, 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (39, 1, 'STR ', ' STRÆDE ', NULL, 1, 0);
    ...
    INSERT INTO fonetik.fonetiskregel VALUES (43, 1, 'ÅSEN ', ' ÅSEN ', NULL, 1, 0);
    ...
    INSERT INTO fonetik.fonetiskregel VALUES (52, 1, 'MØLLE ', ' MØLLE ', NULL, 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (53, 1, 'MØLLEN ', ' MØLLE ', NULL, 1, 0);
    ...
    INSERT INTO fonetik.fonetiskregel VALUES (67, 1, 'KÆR ', ' KÆR ', NULL, 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (68, 1, 'KÆRET ', ' KÆR ', NULL, 1, 0);
    ...
    INSERT INTO fonetik.fonetiskregel VALUES (85, 1, ' NØRRE', ' NORDRE ', NULL, 1, 0);
    ...
    INSERT INTO fonetik.fonetiskregel VALUES (88, 1, ' SØNDER', ' SØNDRE ', NULL, 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (89, 1, ' SØNDRE', ' SØNDRE ', NULL, 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (90, 1, ' SDR ', ' SØNDRE ', NULL, 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (91, 1, ' ØSTRE', ' ØSTRE ', NULL, 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (92, 1, ' ØSTER', ' ØSTRE ', NULL, 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (93, 3, ' Ø ', ' ØSTRE ', NULL, 1, 0);
    ...
    INSERT INTO fonetik.fonetiskregel VALUES (145, 1, 'ALAHARMA', 'ALAHÄRMÄ', NULL, 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (146, 2, '*S ', '* ', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (147, 2, 'KJ*', 'K*', 'EÆØ', 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (148, 2, 'KI*', 'K*', 'EÆØ', 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (149, 1, 'OEHL', 'Ø', NULL, 1, 0);
    ...
    INSERT INTO fonetik.fonetiskregel VALUES (154, 1, 'Ü', 'Y', NULL, 1, 1);
    INSERT INTO fonetik.fonetiskregel VALUES (155, 1, 'Y', 'Y', NULL, 1, 1);
    INSERT INTO fonetik.fonetiskregel VALUES (156, 1, 'AA', 'Å', NULL, 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (157, 1, 'Å', 'O', NULL, 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (158, 1, 'Æ', 'E', NULL, 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (159, 1, 'Ä', 'E', NULL, 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (160, 1, 'Ö', 'Ø', NULL, 1, 1);
    ...
    INSERT INTO fonetik.fonetiskregel VALUES (172, 2, 'C*', 'S*', 'EIYØ', 1, 0);
    ...
    INSERT INTO fonetik.fonetiskregel VALUES (179, 2, 'PH*', 'P*', 'OØ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (180, 1, 'PH', 'F', NULL, 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (181, 2, '*B', '*P', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    ...
    INSERT INTO fonetik.fonetiskregel VALUES (184, 2, ' CH*', ' SJ*', 'AEIOUYØ', 1, 0);
    ...
    INSERT INTO fonetik.fonetiskregel VALUES (189, 2, '*H', '*', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    ...
    INSERT INTO fonetik.fonetiskregel VALUES (201, 2, '*E', '*', 'AEIOUYØ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (202, 2, '*I', '*J', 'AEIOUYØ', 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (203, 2, '*Y', '*J', 'AEIOUYØ', 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (204, 2, 'I*', 'J*', 'AEIOUYØ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (205, 2, 'Y*', 'J*', 'AEIOUYØ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (206, 1, ' HJ', ' J', NULL, 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (207, 2, ' GJ*', ' G*', 'EØ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (208, 2, 'KJ*', 'K*', 'EØ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (209, 1, 'EU', 'ØJ', NULL, 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (210, 1, 'ØV ', 'EV ', NULL, 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (211, 2, 'ØV*', 'EV*', 'BCDFGHJKLMNPRSTV', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (212, 2, '*U', 'OV', 'AO', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (213, 1, 'Y', 'Y', NULL, 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (214, 2, '*D ', '* ', 'AEIOUYØ', 0, 0);
    ...
    INSERT INTO fonetik.fonetiskregel VALUES (221, 2, 'ØD*', 'Ø*', 'BCDFGHJKLMNPRSTV', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (222, 2, '*DE', '*', 'AEIOUYØ', 0, 0);
    ...
    INSERT INTO fonetik.fonetiskregel VALUES (226, 2, '*G ', '* ', 'AEIOUYØ', 0, 0);
    ...
    INSERT INTO fonetik.fonetiskregel VALUES (233, 2, 'ØG*', 'Ø*', 'BCDFGHJKLMNPRSTV', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (234, 2, '*GE', '*', 'AEIOUYØ', 0, 0);
    ...
    INSERT INTO fonetik.fonetiskregel VALUES (239, 2, '*H', '*', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (240, 1, 'AJ', 'EJ', NULL, 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (241, 1, 'OJ', 'ØJ', NULL, 0, 0);
    ...
    INSERT INTO fonetik.fonetiskregel VALUES (255, 2, '*G', '*K', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (256, 2, '*D', '*T', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (257, 4, '', '', NULL, 1, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (258, 1, 'TS', 'S', NULL, 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (259, 2, '*ST', '*S', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    ...
    INSERT INTO fonetik.fonetiskregel VALUES (262, 2, '*SJ', '*S', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (263, 1, ' STJ', ' SJ', NULL, 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (264, 2, '*ST', '*S', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    ...
    INSERT INTO fonetik.fonetiskregel VALUES (267, 2, '*M', '*N', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (268, 2, '*NK ', '*N ', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (269, 2, '*NKB', '*NB', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (270, 2, '*NKC', '*NC', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (271, 2, '*NKD', '*ND', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (272, 2, '*NKF', '*NF', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (273, 2, '*NKG', '*NG', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (274, 2, '*NKH', '*NH', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (275, 2, '*NKJ', '*NJ', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (276, 2, '*NKK', '*NK', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (277, 2, '*NKL', '*NL', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (278, 2, '*NKM', '*NM', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (279, 2, '*NKN', '*NN', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (280, 2, '*NKP', '*NP', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (281, 2, '*NKR', '*NR', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (282, 2, '*NKS', '*NS', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (283, 2, '*NKT', '*NT', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
    INSERT INTO fonetik.fonetiskregel VALUES (284, 2, '*NKV', '*NV', 'ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ', 0, 0);
