...
CREATE TABLE stednavne_udstilling.subtype_translation (
    subtype text,
    subtype_presentation text
);
...
INSERT INTO stednavne_udstilling.subtype_translation (subtype, subtype_presentation)
    VALUES ('køretekniskAnlæg', 'Køreteknisk anlæg'),
    ('landsdel', 'Landsdel'),
    ('stenbrud', 'Stenbrud'),
...
INSERT INTO stednavne_udstilling.subtype_translation (subtype, subtype_presentation)
    VALUES ('udsigtstårn', 'Udsigtstårn'),
    ('ukendt', ''),
    ('vandfald', 'Vandfald'),
    ('varde', 'Varde'),
    ('vejkryds', 'Vejkryds'),
...
INSERT INTO stednavne_udstilling.subtype_translation (subtype, subtype_presentation)
    VALUES ('professionshøjskole', 'Professionshøjskole'),
...
INSERT INTO stednavne_udstilling.subtype_translation (subtype, subtype_presentation)
    VALUES ('uddannelsescenter', 'Uddannelsescenter'),
