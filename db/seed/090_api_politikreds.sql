...
ALTER TABLE basic.politikreds DROP COLUMN IF EXISTS textsearchable_plain_col;
...
ALTER TABLE basic.politikreds DROP COLUMN IF EXISTS textsearchable_unaccent_col;
ALTER TABLE basic.politikreds
...
ALTER TABLE basic.politikreds DROP COLUMN IF EXISTS textsearchable_phonetic_col;
ALTER TABLE basic.politikreds
...
BEGIN
  ...
  stmt = format(E'SELECT
    politikredsnummer::text, navn::text, titel, myndighedskode, geometri, bbox::geometry,
