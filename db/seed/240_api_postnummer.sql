...
COMMENT ON COLUMN api.postnummer.geometri IS 'Geometri i valgt koordinatsystem';

COMMENT ON COLUMN api.postnummer.bbox IS 'Geometriens boundingbox i valgt koordinatsystem';
