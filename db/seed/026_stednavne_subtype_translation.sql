...
DROP TABLE IF EXISTS stednavne_udstil.subtype_translation;
CREATE TABLE stednavne_udstil.subtype_translation (subtype TEXT, subtype_presentation TEXT);
DELETE FROM stednavne_udstil.subtype_translation ;
INSERT INTO stednavne_udstil.subtype_translation (subtype,subtype_presentation) VALUES
