...
ALTER TABLE basic.sogn
    ...
    GENERATED ALWAYS AS (setweight(to_tsvector('basic.septima_fts_config', split_part(sognenavn, ' ', 1)), 'A') ||
...
ALTER TABLE basic.sogn
    ...
    GENERATED ALWAYS AS (setweight(to_tsvector('simple', fonetik.fnfonetik (split_part(sognenavn, ' ', 1), 2)), 'A') ||
