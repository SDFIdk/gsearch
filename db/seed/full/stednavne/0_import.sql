...
VACUUM ANALYZE stednavne.andentopografiflade;
VACUUM ANALYZE stednavne.andentopografipunkt;
VACUUM ANALYZE stednavne.bebyggelse;
VACUUM ANALYZE stednavne.begravelsesplads;
VACUUM ANALYZE stednavne.bygning;
VACUUM ANALYZE stednavne.campingplads;
VACUUM ANALYZE stednavne.farvand;
VACUUM ANALYZE stednavne.fortidsminde;
VACUUM ANALYZE stednavne.friluftsbad;
VACUUM ANALYZE stednavne.havnebassin;
VACUUM ANALYZE stednavne.idraetsanlaeg;
VACUUM ANALYZE stednavne.jernbane;
VACUUM ANALYZE stednavne.landskabsform;
VACUUM ANALYZE stednavne.lufthavn;
VACUUM ANALYZE stednavne.naturareal;
VACUUM ANALYZE stednavne.navigationsanlaeg;
VACUUM ANALYZE stednavne.restriktionsareal;
VACUUM ANALYZE stednavne.sevaerdighed;
VACUUM ANALYZE stednavne.soe;
VACUUM ANALYZE stednavne.standsningssted;
VACUUM ANALYZE stednavne.terraenkontur;
VACUUM ANALYZE stednavne.ubearbejdetnavnflade;
VACUUM ANALYZE stednavne.ubearbejdetnavnlinje;
VACUUM ANALYZE stednavne.ubearbejdetnavnpunkt;
VACUUM ANALYZE stednavne.urentfarvand;
VACUUM ANALYZE stednavne.vandloeb;
VACUUM ANALYZE stednavne.vej;
VACUUM ANALYZE stednavne.stednavn;
