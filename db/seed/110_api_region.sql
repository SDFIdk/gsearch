...
WITH regioner AS
(
 SELECT r.regionskode,
 r.navn,
 st_force2d(r.geometri) AS geometri
 FROM dagi_500m_nohist_l1.regionsinddeling r
 )
SELECT r.navn                         AS praesentation,
       ...
       INTO basic.region_mv
       FROM regioner r
       GROUP BY r.regionskode, r.navn;
       ...
       (
        ...
        setweight(to_tsvector('basic.septima_fts_config', basic.split_and_endsubstring(regionsnavn, 4)),
            'D')
       ) STORED;
