...
s.navn || ' sogn' AS titel,
    ...
    ALTER TABLE basic.sogn DROP COLUMN IF EXISTS textsearchable_plain_col;
    ...
    ALTER TABLE basic.sogn DROP COLUMN IF EXISTS textsearchable_unaccent_col;
    ALTER TABLE basic.sogn
    ...
    ALTER TABLE basic.sogn DROP COLUMN IF EXISTS textsearchable_phonetic_col;
    ALTER TABLE basic.sogn
...
CREATE OR REPLACE FUNCTION api.sogn(input_tekst text,filters text,sortoptions integer,rowlimit integer)
    ...
    stmt = format(E'SELECT
            sognekode::text, navn::text, titel, geometri, bbox::geometry,
