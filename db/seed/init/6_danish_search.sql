...
DROP TEXT SEARCH CONFIGURATION IF EXISTS functions.gsearch_fts_config;

CREATE TEXT SEARCH CONFIGURATION functions.gsearch_fts_config (
...
ALTER TEXT SEARCH CONFIGURATION functions.gsearch_fts_config
