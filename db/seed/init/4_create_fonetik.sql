...
DROP TABLE IF EXISTS functions.fonetiskregel;

CREATE TABLE functions.fonetiskregel (
    regelnr integer,
    type integer,
...
ALTER TABLE functions.fonetiskregel OWNER TO postgres;

INSERT INTO functions.fonetiskregel
    VALUES (1, 1, '.', ' ', NULL, 1, 1);
