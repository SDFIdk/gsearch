...
CREATE TABLE stednavne_udstilling.stednavne_udstilling (objectid integer NOT NULL,
...
presentationstring varchar, area float, CONSTRAINT stednavne_udstilling_pkey PRIMARY KEY (objectid,
navnefoelgenummer));
...
SELECT objectid,
       ...
       geometri,
       st_area(geometri)
FROM stednavne_udstilling.stednavne_union s
...
UPDATE stednavne_udstilling.stednavne_udstilling
SET subtype_presentation = COALESCE(st.subtype_presentation, st.subtype)
FROM stednavne_udstilling.subtype_translation st
WHERE stednavne_udstilling.stednavne_udstilling.subtype = st.subtype;

-- Slet dublerede forekomster (Samme objekt og en uofficiel stavemaade der er magen til)

DELETE
FROM stednavne_udstilling.stednavne_udstilling
  ...
  AND objectid IN
    (SELECT objectid
     ...
     WHERE navnestatus='uofficielt'
       AND EXISTS
         (SELECT '1'
          FROM stednavne_udstilling.stednavne_udstilling s2
...
DELETE
FROM stednavne_udstilling.stednavne_udstilling s
...
FROM stednavne_udstilling.stednavne_udstilling s1
...
WHERE stednavne_udstilling.stednavne_udstilling.presentationstring IS NULL
...
WHERE st_geometrytype(stednavne_udstilling.stednavne_udstilling.geometri_udtyndet) = 'ST_MultiPoint'
...
ALTER TABLE stednavne_udstilling.stednavne_udstilling ADD COLUMN municipality_filter varchar;
...
WHERE stednavne_udstilling.stednavne_udstilling.objectid = t.objectid
