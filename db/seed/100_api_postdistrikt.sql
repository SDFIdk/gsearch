...
(
  ...
  FROM
    dagi_10m_nohist_l1.postnummerinddeling p1
...
ALTER TABLE basic.postdistrikt_mv DROP COLUMN IF EXISTS textsearchable_plain_col;
...
ALTER TABLE basic.postdistrikt_mv DROP COLUMN IF EXISTS textsearchable_unaccent_col;
ALTER TABLE basic.postdistrikt_mv
...
ALTER TABLE basic.postdistrikt_mv DROP COLUMN IF EXISTS textsearchable_phonetic_col;
ALTER TABLE basic.postdistrikt_mv
